...
**File Overview:**  
`Pansharpening/TOOL_SSUN/train_wv2.py` (WorldView-2)  
`Pansharpening/TOOL_SSUN/train_wv3.py` (WorldView-3)  
`Pansharpening/TOOL_SSUN/train_gf2.py` (Gaofen-2)  

*(Use these scripts to train SSUN-Net on different satellite imagery.)*
...
📄 **Official Paper:** https://ojs.aaai.org/index.php/AAAI/article/view/32296
